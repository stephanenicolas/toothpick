...
public class RelaxedFactoryForSingletonsTest extends BaseFactoryTest {
  ...
  @Test
  public void
      testOptimisticFactoryCreationForScopeAnnotation_shouldFail_WhenScopeAnnotationDoesNotHaveRetention() {
    JavaFileObject source =
        JavaFileObjects.forSourceString(
            "test.TestOptimisticFactoryCreationForScopeAnnotation",
            Joiner.on('\n')
  ...
  @Test
  public void
      testOptimisticFactoryCreationForScopeAnnotation_shouldFail_WhenScopeAnnotationDoesNotHaveRuntimeRetention() {
    JavaFileObject source =
        JavaFileObjects.forSourceString(
            "test.TestOptimisticFactoryCreationForScopeAnnotation",
            Joiner.on('\n')
