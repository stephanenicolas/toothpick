 ...
 * injection. <br/>
 * If class FooProvider is annotated with the {@link toothpick.ProvidesSingleton} annotation, the same instance of Foo is reused for each
 * injection. <br/>
 ...
 * {@link javax.inject.Singleton} and {@link toothpick.ProvidesSingleton} can be used to precise how instances of the provider
